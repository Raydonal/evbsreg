...
#' (latitude \eqn{-26.95083^\circ}, longitude \eqn{-48.76194^\circ}) in
#' Itajai, Santa Catarina, Brazil, from July 2010 to October 2020.
#'
#' @format A data frame with 124 rows and 3 variables:
#' \describe{
#'   \item{month}{Integer index of the monthly observation
#'     (1 = July 2010, ..., 124 = October 2020).}
#'   \item{wind}{Numeric. Monthly maximum wind gust speed (m/s).}
#'   \item{pressure}{Numeric. Daily mean atmospheric pressure (mb) on the
#'     day of the monthly maximum.}
#' }
#'
#' @details
